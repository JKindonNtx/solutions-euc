...
![This image shows the the process required to create a master image and the steps required to do so.](../images/BP-2161-EUC-Performance-Benchmarking-Best-Practices_image03.png "Master Image Creation")
