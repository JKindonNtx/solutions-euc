...
Managing the various ports and protocols required to operate can quickly become overwhelming and confusing. These various ports and protocols can be grouped together in a logical unit called a Service within Flow Network Security Next-Gen. <!--JK: did you want next-gen here?-->
...
Monitor mode is a valuable tool within Flow Network Security Next-Gen <!--JK: did you want next-gen here?--> that will allow testing of security policies before enforcing them and blocking un-configured traffic. 
...
- We tested using a single, full HD screen with the default Citrix frames per second configuration. Using multiple screens or other screen resolution settings affects the results. <!--JK: IS this relevant in the context of Flow?-->
...
| --- | --- | --- |
| Total Login | 6.0 seconds - 1.7 % Slower | 5.9 seconds | 
| User Profile | 0.5 seconds | 0.5 seconds | 
| Group Policies | 1.1 seconds - 10.0 % Slower | 1.0 seconds | 
| Connection | 2.8 seconds | 2.8 seconds | 

<!--JK: Did you want to include the differences (% slower etc)-->
