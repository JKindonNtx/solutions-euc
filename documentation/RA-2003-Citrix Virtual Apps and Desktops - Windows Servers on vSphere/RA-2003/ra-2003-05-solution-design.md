...
| Item | Detail | Rationale |
| --- | --- | --- |
| Cluster size | As many as 32 vSphere hosts (minimum of 3 hosts) | Isolated fault domains (best practice) |
| Clusters per vCenter | Up to 2x 24-host or 4x 12-host clusters | Task parallelization |
...
For more details on server optimizations, refer to the [Citrix Windows 10 Optimization Guide](https://support.citrix.com/article/CTX216252) and the [Citrix Optimizer](https://support.citrix.com/article/CTX224676).
