    ...
    Start-Sleep 10
        ...
        if ($Null -ne $Containerid) {
            ...
            if ($Null -ne $ISO) {
                ...
                New-MDTComputer -assettag $Name -macAddress $VMNIC.MacAddress.ToUpper() -settings @{SkipWizard="YES"; TaskSequenceID="W101903O16"; OSDComputerName="$Name"; SkipComputerName="Yes"; SkipTaskSequence="Yes" }
