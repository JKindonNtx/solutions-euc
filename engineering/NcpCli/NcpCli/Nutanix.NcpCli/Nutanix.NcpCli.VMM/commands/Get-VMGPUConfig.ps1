...
<#
    ...
    .EXAMPLE
    PS> Get-VMGPUConfig -PrismIP "10.10.10.10" -PrismUserName "admin" -PrismPassword "password" -VMExtID "08a4c861-3c9a-43b4-a8e0-fdb065dcfe4b" -GPUExtID "08a4c861-3c9a-43b4-a8e0-fdb065dcfe4b"
    ...
    .LINK
    https://github.com/nutanix-enterprise/solutions-euc/blob/main/engineering/NcpCli/Help/Get-VMGPUConfig.md
#>
    ...
    Param (
        ...
        [Parameter(ValuefromPipelineByPropertyName = $true,mandatory=$true)][System.String]$GPUExtID,
    ...
    process {
        ...
        try {
            ...
            $ApiData = (Get-NutanixApiPath -NameSpace "VMM.VMGPUConfig")
            $ApiPath = "$($ApiData)/$($VMExtID)/disks/$($GPUExtID)"
