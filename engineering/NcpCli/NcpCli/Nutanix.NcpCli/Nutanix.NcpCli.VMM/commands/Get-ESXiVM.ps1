...
<#
    ...
    .EXAMPLE
    PS> Get-ESXiVM -PrismIP "10.10.10.10" -PrismUserName "admin" -PrismPassword "password"
    Gets the current ESXi VMs from the Prism Central Appliance.

    .LINK
    https://github.com/nutanix-enterprise/solutions-euc/blob/main/engineering/NcpCli/Help/Get-ESXiVM.md
...
#>
    ...
    process {
        ...
        try {
            ...
            $ApiPath = (Get-NutanixApiPath -NameSpace "VMM.ESXiVM")
