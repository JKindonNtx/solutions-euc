...
<#
    ...
    .EXAMPLE
    PS> Get-VMCdRomConfig -PrismIP "10.10.10.10" -PrismUserName "admin" -PrismPassword "password" -VMExtID "08a4c861-3c9a-43b4-a8e0-fdb065dcfe4b" -CdRomExtID "08a4c861-3c9a-43b4-a8e0-fdb065dcfe4b"
    ...
    .LINK
    https://github.com/nutanix-enterprise/solutions-euc/blob/main/engineering/NcpCli/Help/Get-VMCdRomConfig.md
#>
    ...
    Param (
        ...
        [Parameter(ValuefromPipelineByPropertyName = $true,mandatory=$true)][System.String]$CdRomExtID,
    ...
    process {
        ...
        try {
            ...
            $ApiData = (Get-NutanixApiPath -NameSpace "VMM.VMCdRomConfig")
            $ApiPath = "$($ApiData)/$($VMExtID)/cd-roms/$($CdRomExtID)"
