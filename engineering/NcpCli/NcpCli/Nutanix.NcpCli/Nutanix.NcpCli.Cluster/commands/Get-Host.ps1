...
<#
    ...
    .EXAMPLE
    PS> Get-Host -ClusterExtID "fds3r43-432qqr-w342fewfew"
    Gets all the Hosts from the specific Cluster passed in from the Prism Central Appliance.

    .EXAMPLE
    PS> Get-Host -ClusterExtID "fds3r43-432qqr-w342fewfew" -HostExtID "fdfrwf3-fews43rw2-453253245432543"
...
#>
    ...
    process {   
        ...
        # Build Api Reference
        $BaseApiPath = "/$($ApiRoot)/$($ClusterNameSpace)/$($ClusterApiVersion)/$($ModuleConfig)"
