...
<#
    ...
    .EXAMPLE
    PS> Get-StorageDataStore -PrismIP "10.10.10.10" -PrismUserName "admin" -PrismPassword "password"
    Gets the current Storage Data Stores from the Prism Central Appliance.

    .LINK
    https://github.com/nutanix-enterprise/solutions-euc/blob/main/engineering/NcpCli/Help/Get-StorageDataStore.md
#>
    ...
    process {
        ...
        try {
            ...
            $ApiPath = (Get-NutanixApiPath -NameSpace "Storage.DataStore")
