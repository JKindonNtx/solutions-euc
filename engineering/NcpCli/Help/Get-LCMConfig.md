...
online version: https://github.com/nutanix-enterprise/solutions-euc/blob/main/engineering/NcpCli/Help/Get-LCMConfig.md
schema: 2.0.0
---
...
```
Get-LCMConfig [-PrismIP] <String> [-PrismUserName] <String> [-PrismPassword] <String>
...
### EXAMPLE 1
```
Get-LCMConfig -PrismIP "10.10.10.10" -PrismUserName "admin" -PrismPassword "password"
...
[https://github.com/nutanix-enterprise/solutions-euc/blob/main/engineering/NcpCli/Help/Get-LCMConfig.md](https://github.com/nutanix-enterprise/solutions-euc/blob/main/engineering/NcpCli/Help/Get-LCMConfig.md)
