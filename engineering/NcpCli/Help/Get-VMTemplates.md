...
online version: https://github.com/nutanix-enterprise/solutions-euc/blob/main/engineering/NcpCli/Help/Get-VMTemplates.md
schema: 2.0.0
---
...
```
Get-VMTemplates [-PrismIP] <String> [-PrismUserName] <String> [-PrismPassword] <String>
...
### EXAMPLE 1
```
Get-VMTemplates -PrismIP "10.10.10.10" -PrismUserName "admin" -PrismPassword "password"
...
[https://github.com/nutanix-enterprise/solutions-euc/blob/main/engineering/NcpCli/Help/Get-VMTemplates.md](https://github.com/nutanix-enterprise/solutions-euc/blob/main/engineering/NcpCli/Help/Get-VMTemplates.md)
