...
online version: https://github.com/nutanix-enterprise/solutions-euc/blob/main/engineering/NcpCli/Help/Get-VM.md
schema: 2.0.0
---
...
```
Get-VM [-PrismIP] <String> [-PrismUserName] <String> [-PrismPassword] <String> [[-VerbosePreference] <Object>]
 [<CommonParameters>]
```
...
### EXAMPLE 1
```
Get-VM -PrismIP "10.10.10.10" -PrismUserName "admin" -PrismPassword "password"
...
[https://github.com/nutanix-enterprise/solutions-euc/blob/main/engineering/NcpCli/Help/Get-VM.md](https://github.com/nutanix-enterprise/solutions-euc/blob/main/engineering/NcpCli/Help/Get-VM.md)
