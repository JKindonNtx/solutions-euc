...
online version: https://github.com/nutanix-enterprise/solutions-euc/blob/main/engineering/NcpCli/Help/Get-VMCdRom.md
schema: 2.0.0
---
...
```
Get-VMCdRom [-PrismIP] <String> [-PrismUserName] <String> [-PrismPassword] <String> [-VMExtID] <String>
...
### EXAMPLE 1
```
Get-VMCdRom -PrismIP "10.10.10.10" -PrismUserName "admin" -PrismPassword "password" -VMExtID "08a4c861-3c9a-43b4-a8e0-fdb065dcfe4b"
...
[https://github.com/nutanix-enterprise/solutions-euc/blob/main/engineering/NcpCli/Help/Get-VMCdRom.md](https://github.com/nutanix-enterprise/solutions-euc/blob/main/engineering/NcpCli/Help/Get-VMCdRom.md)
