...
online version: https://github.com/nutanix-enterprise/solutions-euc/blob/main/engineering/NcpCli/Help/Get-FlowServiceGroup.md
schema: 2.0.0
---

# Get-FlowServiceGroup
...
```
Get-FlowServiceGroup [-PrismIP] <String> [-PrismUserName] <String> [-PrismPassword] <String> [[-UUID] <String>]
...
### EXAMPLE 1
```
Get-FlowServiceGroup -PrismIP "10.10.10.10" -PrismUserName "admin" -PrismPassword "password"
Gets the current Flow Service Group from the Prism Central Appliance.
```

### EXAMPLE 2
```
Get-FlowServiceGroup -PrismIP "10.10.10.10" -PrismUserName "admin" -PrismPassword "password" -UUID "78a1e6e7-5900-4f2a-839e-3b993e364889"
...
[https://github.com/nutanix-enterprise/solutions-euc/blob/main/engineering/NcpCli/Help/Get-FlowServiceGroup.md](https://github.com/nutanix-enterprise/solutions-euc/blob/main/engineering/NcpCli/Help/Get-FlowServiceGroup.md)
