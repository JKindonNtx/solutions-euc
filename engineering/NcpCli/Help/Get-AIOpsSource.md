...
online version: https://github.com/nutanix-enterprise/solutions-euc/blob/main/engineering/NcpCli/Help/Get-AIOpsSource.md
schema: 2.0.0
---
...
```
Get-AIOpsSource [-PrismIP] <String> [-PrismUserName] <String> [-PrismPassword] <String>
...
### EXAMPLE 1
```
Get-AIOpsSource -PrismIP "10.10.10.10" -PrismUserName "admin" -PrismPassword "password"
...
[https://github.com/nutanix-enterprise/solutions-euc/blob/main/engineering/NcpCli/Help/Get-AIOpsSource.md](https://github.com/nutanix-enterprise/solutions-euc/blob/main/engineering/NcpCli/Help/Get-AIOpsSource.md)
