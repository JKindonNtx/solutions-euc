...
$SiteName = $env:cvad_site_name
$DatabaseServer = $env:cvad_database_server
$DatabaseServerPort = $env:cvad_database_server_port
$DatabaseName_Site = $env:cvad_database_name_site
$DatabaseName_Logging = $env:cvad_database_name_logging
$DatabaseName_Monitoring = $env:cvad_database_name_monitoring
$LicenseServer = $env:cvad_license_server
$LicenseServerPort = $env:cvad_license_server_port
$LicensingModel = $env:cvad_licensing_model
$ProductCode = $env:cvad_product_code
$ProductEdition = $env:cvad_product_edition
$AdminGroup = $env:cvad_admin_group 
$Role = $env:cvad_role
$Scope = $env:cvad_scope
$GroomingDays = $env:cvad_grooming_days
# -----------------------------------
