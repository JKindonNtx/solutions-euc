...
2. Set global github parameters user.name and user.email:
    ...
    **NOTE:** Using your firstnamelastname as username and Nutanix email address will allow us to identify VMs that are being deployed and in the near future we could use the email address fo
