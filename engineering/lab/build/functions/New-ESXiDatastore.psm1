...
#>
    ...
    Process
    {
        ...
        try {
            $task = Invoke-NutanixAPI -IP "$($IP)" -Password "$($Password)" -UserName "$($UserName)" -APIpath "storage_containers/datastores/add_datastore" -method "POST" -body $Payload
        }
        catch {
