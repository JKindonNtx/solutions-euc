#
# Module manifest for module 'Nutanix.NcpCli'
#
# Generated by: Nutanix Solutions Engineering
#
...
NestedModules = @(
    ...
    @{ModuleName="Nutanix.LE.VMware.Horizon"; ModuleVersion="2311.001"}
    @{ModuleName="Nutanix.LE.VMware.vCenter"; ModuleVersion="2311.001"}
)
