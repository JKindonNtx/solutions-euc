function Start-NTNXFilesMonitoring {
    ...
    $MonitoringScriptBlock = {
        ...
        while ($StopMonitoring -eq $false) {
            ...
            $filesresults = Invoke-PublicApiMethodFiles -Method "GET" -Path "files/v4.0.a2/stats/file-server?metrics=number_of_files,number_of_connections,latency,throughput,iops,write_latency,read_latency,metadata_latency,write_throughput,read_throughput,read_iops,write_iops,metadata_iops"
