function Remove-VSIHVDesktopPool {
    ...
    Write-Log -Message "Removing DesktopPool $Name" -Level Info
    if ($Pool.Type -ne "RDS") {
        ...
        Write-Log -Message "Waiting for DesktopPool $Name to be removed" -Level Info
        ...
        Write-Log -Message "Waiting for Farm F_$Name to be removed" -Level Info
