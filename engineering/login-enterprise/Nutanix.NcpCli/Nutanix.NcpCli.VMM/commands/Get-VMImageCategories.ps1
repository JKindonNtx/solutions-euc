function Get-VMImageCategories {
...
<#
    ...
    .EXAMPLE
    PS> Get-VMImageCategories -PrismIP "10.10.10.10" -PrismUserName "admin" -PrismPassword "password" -ImageExtID "214313412-314132-12fda324-efdsa"
    Gets the Image with Ext ID 214313412-314132-12fda324-efdsa from the Prism Central Appliance and displayed its categories.

    .LINK
    https://github.com/nutanix-enterprise/solutions-euc/blob/main/engineering/NcpCli/Help/Get-VMImageCategories.md
...
#>
    ...
    Param (
        ...
        [Parameter(ValuefromPipelineByPropertyName = $true,mandatory=$true)][System.String]$ImageExtID,
    ...
    process {
        ...
        try {
            ...
            $ApiRoot = (Get-NutanixApiPath -NameSpace "VMM.VMImageCategories")
            $ApiPath = "$($ApiRoot)/$($ImageExtID)/categories"
