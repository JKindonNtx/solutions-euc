...
<#
    ...
    .EXAMPLE
    PS> Get-VMImageLocation -PrismIP "10.10.10.10" -PrismUserName "admin" -PrismPassword "password" -ImageExtID "214313412-314132-12fda324-efdsa"
    Gets the Image with Ext ID 214313412-314132-12fda324-efdsa from the Prism Central Appliance and displayed its locations.

    .LINK
    https://github.com/nutanix-enterprise/solutions-euc/blob/main/engineering/NcpCli/Help/Get-VMImageLocation.md
...
#>
    ...
    process {
        ...
        try {
            ...
            $ApiRoot = (Get-NutanixApiPath -NameSpace "VMM.VMImageLocation")
            $ApiPath = "$($ApiRoot)/$($ImageExtID)/cluster-locations"
