...
<#
    ...
    .EXAMPLE
    PS> Get-StorageContainer -PrismIP "10.10.10.10" -PrismUserName "admin" -PrismPassword "password"
    Gets the current Storage Containers from the Prism Central Appliance.

    .LINK
    https://github.com/nutanix-enterprise/solutions-euc/blob/main/engineering/NcpCli/Help/Get-StorageContainer.md
#>
    ...
    process {
        ...
        try {
            ...
            $ApiPath = (Get-NutanixApiPath -NameSpace "Storage.Container")
