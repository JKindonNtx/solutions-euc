...
Param(
    ...
    #[Parameter(Mandatory = $false)]
    #[Alias('ISO')] [string] $ISO,
    [Parameter(Mandatory = $false)]
    [Alias('VLAN')] [string] $VMNetwork
    #[Parameter(Mandatory = $false)]
    #[Alias('Container')] [string] $Container
)
...
## VM Creation
# Setting Variables
$Name = Read-Host -Prompt 'Specify the VM Name' 
$NumVcpus = Read-Host -Prompt 'How many vCPUs do you want to assign?' 
$MemoryMB = Read-Host -Prompt 'How much RAM do you want to assign (in MBs)?' 
$ISO = Read-Host -Prompt 'Specify the name of the ISO file' 
$VMNetwork = Read-Host -Prompt 'Specify the VLAN for this VM'
$Container = Read-Host -Prompt 'Specify the container for this VM'
