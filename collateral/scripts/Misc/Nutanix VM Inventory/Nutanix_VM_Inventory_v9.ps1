...
#$hosts = @(get-ntnxvm) #| Where-Object {$_.controllerVm -Match "false"}) 
#write-log -message "host information"
#write-log -message "Currently grabbing information on $($hosts.count) hosts"
