...
#The function SetFileName1andFileName2 needs your script output filename
SetFileName1andFileName2 "Nutanix Documentation"

#change title for your report
[string]$Script:Title = "Nutanix Documentation $CoName"
#endregion file name and title name

#region Nutanix Documentation Script Complete
...
#region Nutanix Connection Complete
...
#region Nutanix System Information

#region Basics

$Chapter++
Write-Verbose "$(Get-Date): Chapter $Chapter/$Nutanix Rackable Unit Information"
WriteWordLine 2 0 "Nutanix Rackable Unit Information"
 
## IB - Rather than repeatedly calling the Get-NTXRackableUnit cmdlet, we'll store the value
$NtxRackableUnit = Get-NTNXRackableUnit;
...
$Params = @{       ## IB - This hash table is used for splatting, i.e. the -Hashtable, -Columns, -Format and -AutoFit parameters
    Hashtable = @( ## IB - The -Hashtable parameter needs an array of hashtables. Note the @( and not @{
        @{         ## IB - This is a hash table. As it's the first, it'll be the first row in the table
            ID = $NtxRackableUnit.Id;
            Model = $NtxRackableUnit.Model;
            Location = $NtxRackableUnit.Location;
            Serial = $NtxRackableUnit.Serial;
            Positions = $NtxRackableUnit.Positions;
            Nodes = $NtxRackableUnit.Nodes;
        })
    ...
    Columns = "ID","Model","Location","Serial","Positions","Nodes";
