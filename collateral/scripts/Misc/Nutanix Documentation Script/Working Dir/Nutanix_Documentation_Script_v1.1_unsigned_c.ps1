...
<#
.SYNOPSIS
    Creates a complete inventory of a Nutanix configuration using Microsoft Word 2010, 2013 or 2016.
.DESCRIPTION
...
.EXAMPLE
    ...
    Administrator for the User Name.
.EXAMPLE
    PS C:\PSScript .\Nutanix_Script_v1_0.ps1 -CompanyName "Kees Baggerman Consulting" -CoverPage "Mod" -UserName "Kees Baggerman"
...
.EXAMPLE
    PS C:\PSScript .\Nutanix_Script_v1_0.ps1 -CN "Kees Baggerman Consulting" -CP "Mod" -UN "Kees Baggerman"
