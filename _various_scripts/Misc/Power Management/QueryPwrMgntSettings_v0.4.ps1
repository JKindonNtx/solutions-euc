...
foreach ($vm in $ADVMs){
            try {
                ...
                if ($RemoteRegistry.State -eq 'Running') {
                    ...
                    $result = Invoke-Command -Computername $VM {Get-ItemProperty -Path 'HKLM:\SYSTEM\CurrentControlSet\Control\Power\PowerSettings\7516b95f-f776-4464-8c53-06167f40cc99\8EC4B3A5-6868-48c2-BE75-4F3044BE88A7\' -Name 'Attributes'| select 'Attributes'}
